        ...
        <Card>
          <CardContent className={classes.cardcontents}>          
            <form className={classes.form} align='center' onSubmit={handleSubmit(onSubmit)}>
              ...
              {errors.regNum && errors.regNum.type === 'required' && (<p>Regiment Number is required</p>)}
              {errors.regNum && errors.regNum.type === 'minLength' && (<p>A minimum of 6 numbers required</p>)}
              {errors.regNum && errors.regNum.type === 'maxLength' && (<p>A maximum of 6 numbers required</p>)}
              <br />
