...
namespace GDF_HRMS_v1.HRMS_Mapper
{
    public class HRMSMappings : Profile
    {
        public HRMSMappings()
        {
            ...
            CreateMap<EmployeePI, CreateEmployeeDto>().ForMember(dest =>
            dest.Id,
            opt => opt.MapFrom(src => src.Id)).ForMember(dest =>
            dest.NationalityId,
            opt => opt.MapFrom(src => src.NId)).ForMember(dest =>
            dest.ReligionId,
            opt => opt.MapFrom(src => src.RId)).ForMember(dest =>
            dest.EthnicityId,
            opt => opt.MapFrom(src => src.EId)).ForMember(dest =>
            dest.MaritalStatusId,
            opt => opt.MapFrom(src => src.MId)).ForMember(dest =>
            dest.PositionId,
            opt => opt.MapFrom(src => src.PId)).ForMember(dest =>
            dest.CountryId,
            opt => opt.MapFrom(src => src.CId)).ForMember(dest =>
            dest.RegionId,
            opt => opt.MapFrom(src => src.RegId)).ForMember(dest =>
            dest.RegimentNumber,
            opt => opt.MapFrom(src => src.RNumber)).ForMember(dest =>
            dest.AddressArea,
            opt => opt.MapFrom(src => src.Address.Area)).ForMember(dest =>
            ...
            CreateMap<CreateEmployeeDto, EmployeePI>().ForMember(dest =>
           dest.Id,
           opt => opt.MapFrom(src => src.Id)).ForMember(dest =>
           dest.NId,
           opt => opt.MapFrom(src => src.NationalityId)).ForMember(dest =>
           dest.RId,
           opt => opt.MapFrom(src => src.ReligionId)).ForMember(dest =>
           dest.EId,
           opt => opt.MapFrom(src => src.EthnicityId)).ForMember(dest =>
           dest.MId,
           opt => opt.MapFrom(src => src.MaritalStatusId)).ForMember(dest =>
           dest.PId,
           opt => opt.MapFrom(src => src.PositionId)).ForMember(dest =>
           dest.CId,
           opt => opt.MapFrom(src => src.CountryId)).ForMember(dest =>
           dest.RegId,
           ...
           opt => opt.MapFrom(src => src.DateOfBirth));
            ...
            //opt => opt.MapFrom(src => src.DateOfBirth)).ForPath(dest =>
            //dest.RId,
            //opt => opt.MapFrom(src => src.ReligionId)).ForPath(dest =>
            //dest.EId,
            //opt => opt.MapFrom(src => src.EthnicityId)).ForPath(dest =>
            //dest.MId,
            //opt => opt.MapFrom(src => src.MaritalStatusId)).ForPath(dest =>
            //dest.CId,
